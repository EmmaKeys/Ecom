            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user topbar-head-dropdown dropdown-hover-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        @auth
                        <a class="dropdown-item" href="{{ route('admin_logout')}}" onclick="event.preventDefault(); document.getElementById('adminLogout-form').submit();"><i class="bi bi-box-arrow-right text-muted fs-15 align-middle me-1"></i> <span class="align-middle">Logout</span></a>

                        <form action="{{ route('admin_logout') }}" method="post" class="d-none" id="adminLogout-form">
                            @csrf
                        </form>
